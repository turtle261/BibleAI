...
class BibleAgent:
    def __init__(self):
        ...
        self.book_names = {
            ...
            '1ts': '1 Thessalonians', '2ts': '2 Thessalonians', '1m': '1 Timothy',
            '2m': '2 Timothy', 'tt': 'Titus', 'pm': 'Philemon', 'hb': 'Hebrews',
            'jm': 'James', '1pe': '1 Peter', '2pe': '2 Peter', '1jo': '1 John',
            '2jo': '2 John', '3jo': '3 John', 'jud': 'Jude', 'rv': 'Revelation'
        }
